 ...
 <!-- BEGIN SAMPLE TABLE PORTLET-->
        <div class="portlet box green ">
            <div class="portlet-title">
                <div class="caption">Add Sector
                </div>
            </div>
            <div class="portlet-body form">
                <div style="color:red;text-align:center;margin-left: -392px;"> <?php echo $this->Session->flash(); ?></div>
                <?php echo $this->Form->create("Sector", array('controller'=>'sectors','autocomplete' => 'off','id' => 'sectoradd', 'class' => 'form-horizontal')); ?>
                <div class="form-body">

                    <div class="form-group">
                        <label class="col-md-3 control-label">Sector Name:</label>
                        <div class="col-md-6">
                            <input type="text" name="data[Sector][sector_name]"  class="form-control">
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    var validator = $("#sectoradd").validate({
        rules: {
