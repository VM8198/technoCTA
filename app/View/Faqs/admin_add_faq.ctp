            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <?php echo $this->Form->text('question', array("class" => "form-control",'name'=>'data[Faq][question]')); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Answer:</label>
                        <div class="col-md-9">
                            <?php echo $this->Form->textarea('answer', array('class' => 'ckeditor','id' => 'answer','name'=>'data[Faq][answer]')); ?>
                        </div>
                    </div>
                ...
                <div class="form-actions fluid">
                    <div class="col-md-offset-3 col-md-6">
                        ...
                        <a class="btn default" href="<?php echo $this->html->url(array('controller' => 'faqs','action' => 'admin_faqList')); ?>">
                            Cancel</a>
                    </div>
                </div>
