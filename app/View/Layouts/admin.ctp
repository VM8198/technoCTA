...
<html lang="en" class="no-js">
     <head>
        ...
        <!-- END THEME STYLES -->
        <link rel="icon" href="http://techno.sdssoftltd.co.uk/img/fav-icon.png">
    </head>
    <!-- END HEAD -->
    <!-- BEGIN BODY -->
        ...
        <div class="header navbar navbar-fixed-top">
            ...
            <div class="header-inner">
                ...
                <a class="navbar-brand" href="<?php echo $this->html->url(array('controller'=>'users','action'=>'admin_dashboard','id'=>'formid')); ?>">
                        <!--<img src="admin_assets/img/logo.jpg" alt="logo" class="img-responsive"/>-->
                    <?php echo $this->html->image('logo.jpg', array('height'=>"60px",'width'=>'150px')); ?>
