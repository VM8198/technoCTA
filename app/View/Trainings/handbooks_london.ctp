...
<div class="site-breadcrumb">
  <div class="container"> 
  	<a href="<?php echo $this->html->url(array('controller' => 'homes', 'action' => 'index'));?>"><i class="fa fa-home"></i> Home</a> <i class="fa fa-angle-right"></i> <span>Handbooks-London underground</span> 
  </div>
</div>
...
<section id="inner-headline-gallery" class="about-page">
  <div class="carousel-text" align="center">
    <h1>Handbooks-<strong>London underground</strong></h1>
  </div>
</section>
<section class="about-section spad pt-0">
<div class="container"> 
	<h4>Handbooks-London underground</h4>
    <div class="row">
