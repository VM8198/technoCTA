 ...
 <!-- BEGIN SAMPLE TABLE PORTLET-->
        <div class="portlet box green ">
            <div class="portlet-title">
                <div class="caption">Add Location
                </div>
            </div>
            <div class="portlet-body form">
                <div style="color:red;text-align:center;margin-left: -392px;"> <?php echo $this->Session->flash(); ?></div>
                <?php echo $this->Form->create("Location", array('controller'=>'locations','autocomplete' => 'off','id' => 'locationadd', 'class' => 'form-horizontal')); ?>
                <div class="form-body">
                    <div class="form-group">
                        <label class="col-md-3 control-label">Location Name:</label>
                        <div class="col-md-6">
                            <input type="text" name="data[Location][location]"  class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Complete Location:</label>
                        <div class="col-md-6">
                            <input type="text" name="data[Location][complete_location]"  class="form-control">
                        </div>
                    </div>   
                </div>
...
<script type="text/javascript">
    var validator = $("#locationadd").validate({
        rules: {
