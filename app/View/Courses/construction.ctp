...
<div class="site-breadcrumb">
	<div class="container"> <a href="<?php echo $this->html->url(array('controller' => 'homes', 'action' => 'index'));?>"><i class="fa fa-home"></i> Home</a> <i class="fa fa-angle-right"></i> <span>Construction</span> </div>
</div>
<!-- Breadcrumb section end -->

<section id="inner-headline-gallery" class="construction-page">
	...
	<div class="col-sm-12">
		<div class="row right-side">
					...
					<div class="right-sides">
						...
						<?php echo $this->Form->create('Course', array('controller' => 'courses', 'action' => 'construction','type' => 'get', 'id' => 'search_course')); ?>
						<div class="row">
							<div class="col-sm-3">
								<div class="calender">
