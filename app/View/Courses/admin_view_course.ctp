    ...
    <div class="col-md-12">
        <div class="portlet box green">
			...
			<!-- <div class="button-del"> -->	<?php
                                    ...
                                    //         ), array(
                                    //     'escape' => false,
                                    //     'confirm' => 'Are you sure you want to delete this course details?',
                                    //     'title' => 'Delete'
                                    // ));
                                    ?>
            ...
            <div class="table" style="margin-top:30px;">
                ...
                <table class="table table-striped table-bordered table-hover" style="text-align:center;">
                    ...
                    <tr>
                        ...
                        <td align = "left"><?php 
                        if (!empty($courseView['Course']['archivedate']) ) {
                             echo $courseView['Course']['archivedate'];
                        }
                        else{
                             echo $courseView['Course']['start_date'];
                        }
                        ?></td>
                    </tr>
                    <tr>
                        ...
                        <td align = "left"><?php 
                        if (!empty($courseView['Course']['archive_stime']) ) {
                            echo $courseView['Course']['archive_stime']; 
                        }
                        else{
                              echo $courseView['Course']['start_time']; 
                        }
                      ?></td>
                    </tr>
					<tr>
                        ...
                        <td align = "left"><?php 
                        if (!empty($courseView['Course']['archive_etime']) ) {
                            echo $courseView['Course']['archive_etime'];
                        }
                        else{
                            echo $courseView['Course']['end_time'];
                        }
                         ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width:200px;">PDF:</td>
                        <td align = "left"><?php echo $courseView['Course']['pdf']; ?></td>
                    </tr>
					<tr>
