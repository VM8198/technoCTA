                ...
                <div class="form-body">
                    ...
                    // echo $courseDetail[Course][start_date];
                        ...
                        <div class="col-md-4" align="left">
                             ...
                             <!--<input type="text" name="data[Course][start_time][]" id="timepicker" class="form-control" value="<?php //$exp1 = (explode(",",$courseDetail['Course']['start_time'])); echo $exp1[$i];  ?>" >-->
							  <select type="text" name="data[Course][start_time][]" class="form-control" id="1dates<?php echo $i ?>">
                        ...
                        <div class="col-md-3" align="left">
                            <label class=" control-label">End Time:</label>
                             <!--<input type="text" name="data[Course][end_time][]" id="timepicker1" class="form-control" value="<?php //$exp2 = (explode(",",$courseDetail['Course']['end_time']));echo $exp2[$i];  ?>" >-->
							<select type="text" name="data[Course][end_time][]" id="2dates<?php echo $i ?>" class="form-control">
                             <option class="" value="12:00am" >12:00am</option>
                                <option class="ui-timepicker-am" value="12:30am" >12:30am</option>
                                <option class="ui-timepicker-am" value="1:00am" >1:00am</option>
                                <option class="ui-timepicker-am" value="1:30am" >1:30am</option>
                       ...
                       <!--  <div class="col-md-1"><input type="button" onclick="getdatetime('dates<?php echo $i ?>')" value="Archive"></div> -->
                        <div class="col-md-1"><input type="checkbox" class="btn green greens" onclick="checkdatetime('dates<?php echo $i ?>')" value="Archive" style="margin-top:50px;"></div>
                        </div>
                      ...
                      <input type="button" style="display: none;" id="buttonId" class="btn green greens sss"  onclick="getdatetime('dates<?php echo $i ?>')" value="Archive">
...
$('body').on('focus',".date1", function(){
        ...
        function getdatetime(id){
            ...
            var courseId =  $('#currentCourseId').val();
             ...
             $.ajax({
                url:"<?php echo SITEPATH ?>admin/courses/editCourse",
                type : 'post',
            
                data : "Course="+ courseDate + "&sTime=" + startTime + "&eTime=" + endTime + "&courseId=" + courseId,
                success: function(response){
                   
                    if (response == 'admin_courseList') {
                window.location.href = '<?php echo SITEPATH ?>admin/courses/courseList'; 
                    }
                    else{
                 window.location.href = '<?php echo SITEPATH ?>admin/courses/editCourse/'+response; 
                    }
