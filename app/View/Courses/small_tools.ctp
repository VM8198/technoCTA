...
<div class="site-breadcrumb">
  <div class="container"> <a href="<?php echo $this->html->url(array('controller' => 'homes', 'action' => 'index'));?>"><i class="fa fa-home"></i> Home</a> <i class="fa fa-angle-right"></i> <span>Small Tools</span> </div>
</div>
<!-- Breadcrumb section end -->

<section id="inner-headline-gallery" class="tools-page">
  <div class="carousel-text" align="center">
    <h1>Small <strong>Tools</strong></h1>
  </div>
</section>
  ...
  <div class="col-sm-12">
    <div class="row right-side">
          ...
          <div class="right-sides">
            ...
            <?php echo $this->Form->create('Course', array('controller' => 'courses', 'action' => 'small_tools','type' => 'get', 'id' => 'search_course')); ?>
            <div class="row">
              <div class="col-sm-3">
                <div class="calender">
          ...
          <table class="table table-striped">
            ...
            <div style="color:#449ac6;font-size:13px;"><?php $count1 = $result['Course']['delegates_no'] - sizeof($result['TransactionLog']); 
            if($count1==1){
						echo "1 Space left.";
					}else{
						if($count1>0){
      ...
      // }
          ...
          <option disabled="disabled" selected="selected" style="display:none">Course Date</option>
            ...
            <?php }else{ ?>
               <button class="btn btn-success pading-button" data-toggle="modal" id="ing1<?php echo $result['Course']['id']; ?>" data-target="#Indivitualnonrail<?php echo $result['Course']['id']; ?>" disabled>Select Date</button>
               <?php } ?>
          </td>
					<?php }?>
					<?php if($_SESSION['Auth']['User']['user_type']=="Company"){?>
