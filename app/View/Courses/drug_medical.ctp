...
<div class="site-breadcrumb">
  <div class="container"> <a href="<?php echo $this->html->url(array('controller' => 'homes', 'action' => 'index'));?>"><i class="fa fa-home"></i> Home</a> <i class="fa fa-angle-right"></i> <span>Drug & Alcohol Screening & Medical Assessments</span> </div>
</div>
<!-- Breadcrumb section end -->

<section id="inner-headline-gallery" class="tools-page">
  <div class="carousel-text" align="center">
    <h1>Drug & Alcohol Screening & Medical Assessments</strong></h1>
  </div>
</section>
  ...
  <div class="col-sm-12">
    <div class="row right-side">
          ...
          <div class="right-sides">
            ...
            <?php echo $this->Form->create('Course', array('controller' => 'courses', 'action' => 'drug_medical','type' => 'get', 'id' => 'search_course')); ?>
            <div class="row">
              <div class="col-sm-3">
                <div class="calender">
            ...
            <tbody>
            	<?php $i=1; foreach($list as $result) { ?>
              	<tr>
					...
					<td><?php echo $result['Course']['delegates_no']; ?></br>
            <div style="color:#449ac6;font-size:13px;">
              <?php $count1 = $result['Course']['delegates_no'] - sizeof($result['TransactionLog']); 
          if($count1==1){
						echo "1 Space left.";
					}else{
						if($count1>0){
      ...
      <Select type="text" class="form-control" id="<?php echo $result['Course']['id']; ?>" style="width:130px;font-size: 14px;" onChange="datefunction(this);">
          ...
          <td id="dp<?php echo $result['Course']['id']; ?>"><?php //echo $value['Course']['start_time']; ?></td>  
							...
							<?php } ?>
							</td><td id="dpQ<?php echo $result['Course']['id']; ?>"><?php //echo $value['Course']['end_time']; ?></td>
							<td style="display:none;">
							<?php for($i=0;$i<=20;$i++){ ?>
            ...
            <button class="btn btn-success pading-button" data-toggle="modal"  data-target="#Indivitualnonrail<?php echo $result['Course']['id']; ?>" disabled>No Space</button>
             <?php }else{ ?>
              <button class="btn btn-success pading-button disbale" data-toggle="modal" data-target="#Indivitualnonrail<?php echo $result['Course']['id']; ?>" id="ing1<?php echo $result['Course']['id']; ?>" disabled="">Select Date</button>
                <?php } ?>
          </td>
					<?php }?>
					<?php if($_SESSION['Auth']['User']['user_type']=="Company"){?>
