...
<!-- flash message old -->
 <!--<div style="background:#5cb85c;color:#ffffff;text-align:center;font-size:18px;position: relative;"
  id= "successMsg">--><?php  $vara = $this->Session->flash('form1'); 
 // echo $vara
  ?>
  </div> 
  ...
  <?php  if($this->Session->flash('form1')); 
       $message = $this->Session->flash('form1');
        ?>
...
$(document).ready(function(){
       var ins = '<?php echo $vara; ?>';
       if(ins){
      //   alert("hi")
        document.getElementById("alertshowmsg").innerHTML = ins;
