               ...
               <div class="row">
				  ...
				  <div class="col-lg-12" align="right">
                                 ...
                                 <li class="nav-item disabled" role="presentation">
                                    ...
                                    <li class="nav-item disabled" role="presentation">
                                       <a class="site-btn modal-btn Add_btn" href="#" title="Next" onclick="INextTab(<?php echo $value['Course']['id'];?>);"><i class="fa fa-angle-double-right"></i></a>
                                    </li>
                                 </ul>
                              </div>
               </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="buzz<?php echo $value['Course']['id'];?>">
                           <div class="row">
                              ...
                              <div class="col-lg-3 dollar">
                                 <label class="form-text">Price Per Deligates (excl VAT)</label>
                                 <input type="text" class="contactmodal excvat<?php echo $value['Course']['id'];?>" readonly="true" id="4TextBoxesGroup<?php echo $value['Course']['id'];?>" name="data[delegate_price][]" placeholder="Price Per Deligates (excl VAT)" value="<?php echo $value['Course']['delegate_price'];?>">
                                 <p class="dollarsign">&#163;</p>
                              </div>
                              <div class="col-lg-3 dollar">
                                 <label class="form-text">Price Per Deligates (Incl VAT)</label>
                                 <input type="text" class="contactmodal ddlSelect<?php echo $value['Course']['id'];?>" id="5TextBoxesGroup<?php echo $value['Course']['id'];?>" name="data[delegate_price][]" readonly="true" placeholder="Price Per Deligates (Incl VAT)" value="<?php echo $value['Course']['delegate_price'] +  $value['Course']['delegate_price'] * 20/100 ;?>">
                                 <p class="dollarsign">&#163;</p>
                             </div>
                           ...
                           <div id='TextBoxesGroup<?php echo $value['Course']['id'];?>'></div>
                         ...
                         <!--  <div id="1ddlSelect<?php //echo $value['Course']['id'];?>"></div>-->
                           <div class="row">
                           <div class="col-lg-6">
                                <button class="site-btn modal-btn Add_btn AddField addbox" type="button"  data-id="<?php echo $value['Course']['id'];?>" id='TextBoxesGroup<?php echo $value['Course']['id'];?>'>Add</button>
                                <button class="site-btn modal-btn Add_btn removeButton addbox" type="button"   id='<?php echo $value['Course']['id'];?>'>Remove</button>
                                </div>
                           <div class="col-lg-3 dollar">
            ...
            <div class="col-sm-12" id="non<?php echo $id ?>">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-12" align="right">
                              <ul class="nav nav-tabs" role="tablist" style="float:right;">
                                 <li class="nav-item disabled" role="presentation">
                                    <a class="site-btn modal-btn Add_btn" href="#" title="Previus" onclick="OPreviousTab(<?php echo $value['Course']['id'];?>)"><i class="fa fa-angle-double-left"></i></a>
                                 </li>
                              </ul>
                    </div>
				  </div>
                     ...
                     <div role="tabpanel" class="tab-pane fade" id="buzz<?php echo $value['Course']['id'];?>">
                        <div class="row">
                           ...
                           <div class="row">
                                ...
                                <div class="col-lg-3 dollar">
                                    <label class="form-text">Price Per Deligates (excl VAT)</label>
                                    <input type="text" class="contactmodal textexcl<?php echo $value['Course']['id'];?>" name="data[delegate_price][]" placeholder="Price Per Deligates (excl VAT)" id="1TextBoxesGroup1<?php echo $value['Course']['id'];?>" value="<?php echo $value['Course']['delegate_price'];?>">
                                    <p class="dollarsign">&#163;</p>
                                </div>
                                <div class="col-lg-3 dollar">
                                    <label class="form-text">Price Per Deligates (Incl VAT)</label>
                                    <input type="text" class="contactmodal textincl<?php echo $value['Course']['id'];?>" name="data[delegate_price][]" placeholder="Price Per Deligates (Incl VAT)" id="2TextBoxesGroup1<?php echo $value['Course']['id'];?>" value="<?php echo $value['Course']['delegate_price'] +  $value['Course']['delegate_price'] * 20/100 ;?>">
                                    <p class="dollarsign">&#163;</p>
                                </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="col-lg-3 dollar" >
                                    <label class="form-text">Price Per Deligates (excl VAT)</label>
                                    <input type="text" class="contactmodal textexcl<?php echo $value['Course']['id'];?>" name="data[delegate_price][]" placeholder="Price Per Deligates (excl VAT)"  value="<?php echo $value['Course']['delegate_price'];?>">
                                    <p class="dollarsign">&#163;</p>
                                </div>
                                <div class="col-lg-3 dollar">
                                    <label class="form-text">Price Per Deligates (Incl VAT)</label>
                                    <input type="text" class="contactmodal textincl<?php echo $value['Course']['id'];?>" name="data[delegate_price][]" placeholder="Price Per Deligates (Incl VAT)" value="<?php echo $value['Course']['delegate_price'] +  $value['Course']['delegate_price'] * 20/100 ;?>">
                                    <p class="dollarsign">&#163;</p>
                                </div>
                        </div>
                        <div class="row">
                        ...
                        <button class="site-btn modal-btn Add_btn removeButton1 addbox" type="button" id="<?php echo $value['Course']['id'];?>">Remove</button>
                        </div>
                        <div class="col-lg-3 dollar"> 
                             <label class="form-text tot">Total (Excl VAT)</label>
                              <input type="text" class="contactmodal" name="data[delegate_price][]" placeholder="Total" id="totalexcs<?php echo $value['Course']['id'];?>" value=""> 
                              <p class="dollarsign">&#163;</p>
                            </div>
                        <div class="col-lg-3 dollar">
                             <label class="form-text tot">Total (Incl VAT)</label>
                              <input type="text" class="contactmodal" name="data[delegate_price][]" placeholder="Total" id="totalincs<?php echo $value['Course']['id'];?>" value="">
                              <p class="dollarsign">&#163;</p>
                            </div></div>
                        <div class="row">
                          <!-- <div class="col-lg-12 booking button">
...
<!--<script type="text/javascript">
            ...
            if(e>0)for(i=1;i<=e;i++){
                var a=$(document.createElement("div")).attr("id","divTxt"+i);a.after().html('\t<div class="row">
                    <div class="col-lg-2"><label class="form-text">First Name</label><input type="text" class="contactmodal valid" 
                    name="data[first_name][]" placeholder="First Name" onkeypress="return ValidateAlpha(event);"></div>
                    <div class="col-lg-2"><label class="form-text">Last Name</label><input type="text" class="contactmodal valid" 
                    name="data[last_name][]" placeholder="Last Name" onkeypress="return ValidateAlpha(event);"></div><div class="col-lg-2">
                        <label class="form-text">Sentinel Number</label><input type="tel" class="contactmodal" name="data[sentinel][]" 
                        maxlength="7" placeholder="Sentinel Number"></div><div class="col-lg-3"><label class="form-text">Price Per
                             Deligates(excl VAT)</label><input type="text" class="contactmodal valid input" 
                             name="data[delegate_price][]" readonly="true" value="" placeholder="Price Per Deligates (excl VAT)" 
                             id="exc'+i+'"></div><div class="col-lg-3"><label class="form-text">Price Per Deligates (Incl VAT)</label>
                             <input type="text" class="contactmodal valid newdd'+f+'" name="data[delegate_price][]" readonly="true" 
                             value=""  placeholder="Price Per Deligates (Incl VAT)" id="inc'+i+'"></div></div>
                             <a href="#" id="'+n+'" class="remove">Remove</a>'),a.appendTo("#1"+f)
...
<script>
function PreviousTab(s) {
    $("#profile" + s).addClass("in active show"), 
    $("#buzz" + s).removeClass("in active show"), 
    $("#step1" + s).addClass("active"), 
    $("#step2" + s).removeClass("active")
}
function NextTab(e){
    $("#references"+e).addClass("in active show"),
    $("#buzz"+e).removeClass("in active show"),
    $("#step3"+e).addClass("active"),
    $("#step2"+e).removeClass("active")}
function PRETab(e){
    $("#references"+e).removeClass("in active show"),
    $("#buzz"+e).addClass("in active show"),
    $("#step2"+e).addClass("active"),
    $("#step3"+e).removeClass("active")}

</script>

<script>
function IFunction(s){
    $("#Iprofile" + s).removeClass("in active show"); 
    $("#Ibuzz" + s).addClass("in active show"); 
    $("#Istep2" + s).addClass("active"); 
    $("#Istep1" + s).removeClass("active");
}</script>
<script>
function INextTab(e){
    ...
    <script>
function IPreviousTab(e){
    $("#Iprofile" + e).addClass("in active show"), 
    $("#Ibuzz" + e).removeClass("in active show"), 
    $("#Istep1" + e).addClass("active"), 
    $("#Istep2" + e).removeClass("active")
}
</script>
<script>
function IPRETab(e){
    $("#Ireferences"+e).removeClass("in active show"),
    $("#Ibuzz"+e).addClass("in active show"),
    $("#Istep2"+e).addClass("active"),
    $("#Istep3"+e).removeClass("active")}
    </script>
    <script>
    function OPreviousTab(e){
        $("#I1step"+e).addClass("in active show"),
    $("#I2step"+e).removeClass("in active show"),
    $("#2Istep"+e).removeClass("active"),
    $("#1Istep"+e).addClass("active")}
    </script>
    <script>
    function ONextTab(e){
        $("#I1step"+e).removeClass("in active show"),
    $("#I2step"+e).addClass("in active show"),
    $("#2Istep"+e).addClass("active"),
    $("#1Istep"+e).removeClass("active")}
    </script>
<script>
...
<script type="text/javascript">
$(document).ready(function(){var e=1;$(".AddField").click(function(){var t=this.id,l=$(this).data("id"),a=document.getElementById("4"+t).value,o=document.getElementById("5"+t).value;if(e>9)return alert("Only 9 textboxes allow"),!1;var d=$(document.createElement("div")).attr("id","TextBoxDiv"+e);d.after().html('<div class="row"><div class="col-lg-2"><label class="form-text">First Name</label><input type="text" class="contactmodal valid" name="data[first_name][]" placeholder="First Name" onkeypress="return ValidateAlpha(event);"></div><div class="col-lg-2"><label class="form-text">Last Name</label><input type="text" class="contactmodal valid" name="data[last_name][]" placeholder="Last Name" onkeypress="return ValidateAlpha(event);"></div><div class="col-lg-2"><label class="form-text">Sentinel Number</label><input type="tel" class="contactmodal" name="data[sentinel][]" maxlength="7" placeholder="Sentinel Number"></div><div class="col-lg-3 dollar"><label class="form-text">Price Per Deligates (excl VAT)</label><input type="text" class="contactmodal valid input" name="data[delegate_price][]" readonly="true" value="" placeholder="Price Per Deligates (excl VAT)" id="exc'+e+'"><p class="dollarsign">&#163;</p></div><div class="col-lg-3 dollar"><label class="form-text">Price Per Deligates (Incl VAT)</label><input type="text" class="contactmodal valid newdd" name="data[delegate_price][]" readonly="true" value=""  placeholder="Price Per Deligates (Incl VAT)" id="inc'+e+'"><p class="dollarsign">&#163;</p></div></div>'),d.appendTo("#"+t),document.getElementById("exc"+e).value=a,document.getElementById("inc"+e).value=o;var n=4*o,c=parseFloat(o*e)+parseFloat(n);document.getElementById("TotVal"+l).value=c;var r=4*a,s=parseFloat(a*e)+parseFloat(r);document.getElementById("TotExVal"+l).value=s,e++}),$("body").on("click",".removeButton",function(){if(1==e)return alert("No more textbox to remove"),!1;e--,$("#TextBoxDiv"+e).remove();var t=this.id,l=document.getElementById("TotVal"+t).value,a=document.getElementById("5TextBoxesGroup"+t).value,o=parseFloat(l)-parseFloat(a);document.getElementById("TotVal"+t).value=o;var d=document.getElementById("TotExVal"+t).value,n=document.getElementById("4TextBoxesGroup"+t).value,c=parseFloat(d)-parseFloat(n);document.getElementById("TotExVal"+t).value=c})});
</script>
<script>
$(document).ready(function(){
  ...
  $(".AddField1").click(function () {
      ...
      //alert(f)
      var n = $(this).data('id'); 
       var j = document.getElementById("1"+f).value;
       var k = document.getElementById("2"+f).value;
      if(counter>9){
      ...
      var newTextBoxDiv = $(document.createElement('div'))
          .attr("id", 'TextBoxDivss' + counter);

      newTextBoxDiv.after().html('<div class="row"><div class="col-lg-3"><label class="form-text">First Name</label><input type="text" class="contactmodal valid" name="data[first_name][]" placeholder="First Name" onkeypress="return ValidateAlpha(event);"></div><div class="col-lg-3"><label class="form-text">Last Name</label><input type="text" class="contactmodal valid" name="data[last_name][]" placeholder="Last Name" onkeypress="return ValidateAlpha(event);"></div><div class="col-lg-3 dollar"><label class="form-text">Price Per Deligates (excl VAT)</label><input type="text" class="contactmodal valid" name="data[delegate_price][]" id="excs'+counter+'" placeholder="Price Per Deligates (excl VAT)" ><p class="dollarsign">&#163;</p></div><div class="col-lg-3 dollar"><label class="form-text">Price Per Deligates (Incl VAT)</label><input type="text" class="contactmodal valid" name="data[delegate_price][]"  id="incs'+counter+'"  placeholder="Price Per Deligates (Incl VAT)" ><p class="dollarsign">&#163;</p></div></div>');

      newTextBoxDiv.appendTo("#"+f);
    document.getElementById("excs"+counter).value = j;
     document.getElementById("incs"+counter).value = k;
      var p = j*counter;
     var qq = j*4;
      var kt = parseFloat(p) + parseFloat(qq);
      document.getElementById("totalexcs"+n).value = kt;

      //
     var p1 = k*counter;
     var qq1 = k*4;
      var kt1 = parseFloat(p1) + parseFloat(qq1);
     document.getElementById("totalincs"+n).value = kt1;
      counter++;
   ...
   $("body").on("click",".removeButton1",function(){
      ...
      counter--;
      $("#TextBoxDivss" + counter).remove();
          var kp = this.id;
           var ip = document.getElementById("totalexcs"+kp).value;
           var pp = document.getElementById("1TextBoxesGroup1"+kp).value;
           var tt = parseFloat(ip) - parseFloat(pp);
           document.getElementById("totalexcs"+kp).value = tt;

           //
           var ip1 = document.getElementById("totalincs"+kp).value;
           var pp1 = document.getElementById("2TextBoxesGroup1"+kp).value;
           var tt1 = parseFloat(ip1) - parseFloat(pp1);
           document.getElementById("totalincs"+kp).value = tt1;
   });
