...
class PayzoneGateway
{
  ...
  public function __construct()
  {
    ...
    self::setMerchantId('SDSSof-9761506');// Enter the merchant ID from the MMS
    self::setMerchantPassword('6BQHBIKXGF');// Enter the merchant Password from the MMS
    self::setPreSharedKey('pq66OYjX/kfYpWsKojfQY+t8BJYViCv4DNrym1enug==');// Enter the pre shared key from the MMS
    self::setSecretKey('SHA1');// secret key used to protect and verify data
    ...
    public function setURL($act, $val = null)
{
    ...
    {
      $type = ($this->debug_mode) ? 'hidden' : 'hidden';
      $output="";
    ...
    public function recordTransaction($order_id, $amounttidy, $amountminor, $amountmajor, $currency_code, $crossreference, $statuscode, $type, $transactiondatetime, $message)
    {
      ...
      $recordTransaction = DB\DBDemo::saveTransaction($user_id,$course_id,$order_id, $amounttidy, $amountminor, $amountmajor, $currency_code, $crossreference, $statuscode, $type, $transactiondatetime, $message, $this->getIntegrationType2());#DBExample
