...
<div class='payzone-form-section'>
  ...
  <input type="text" name="EmailAddress" id="email" value="<?php echo (isset($_POST["EmailAddress"]))?$_POST["EmailAddress"]:null; ?>" onblur="validateemail(this);" onchange="validateemail(this)" oninput="this.onchange();" onkeyup="this.onchange();" onpaste="this.onchange();" autofocus="off" autocomplete="off"/>
